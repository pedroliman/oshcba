################################################################################
##
##  Tratamentos Dados Calculadora SESI
##  Version: 1.0
...
### ------------------------------------------------------
dataset_check1 = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
                                                     range = "Check_support!A1:D71",
                                                     col_names = TRUE))

### Ler Planilha de ASIS - PARAMETRIZACAO
### ------------------------------------------------------
dataset_ASIS_param_cadastEmp = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
dataset_ASIS_param_cadastSesi = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
versao_calculadora = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
                                                      range = "Parametrização!C19",
                                                      col_names = FALSE))

names(versao_calculadora) <- c("versao_calculadora")

dataset_ASIS_param_Modulos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
### ------------------------------------------------------
dataset_ASIS_Simple_INSS = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
### ------------------------------------------------------
dataset_ASIS_Simple_Outros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioMultas == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_multas = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioReclamatorias == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_Reclamatorias = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioAcoesRegressivasINSS == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_AcoesRegressivasINSS = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioDespesasMedicas == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_DespesasMedicas = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioPlanodeSaude == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_PlanodeSaude = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioInterrupcaoAcidentes == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_InterrupcaoAcidentes = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioInterdicaoFiscalizacao == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_InterdicaoFiscalizacao = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioReabilitacao == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_Reabilitacao = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
### 10. Dimensão: BeneficioSeguroPatrimonial // DImensão não necessita de dado de entrada ASIS - Forçado que sempre será NULL os respectrivos objetos
if(DB_ASIS_param_Modulos$BeneficioSeguroPatrimonial == FALSE){ # Carregar somente se o usuário selecionou o módulo
  
  dataset_ASIS_SeguroPatrimonial = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioPresenteismo == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_Presenteismo = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioMPInsumos == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_MPInsumos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioRefugoERetrabalho == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_RefugoERetrabalho = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioImagemContratacao == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  dataset_ASIS_ImagemContratacao = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
if(DB_ASIS_param_Modulos$BeneficioClima == TRUE){ # Carregar somente se o usuário selecionou o módulo
  ...
  # dataset_ASIS_Clima = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada - v1.3 - Versão Completa.xlsx", 
...
# eventos_pdf
# eventos_pdf_arb
rmarkdown::render("/home/pedro/Documents/dev/oshcba/tests/testesmanuais/report.rmd", encoding = getOption("encoding"))
...
if((sum(DB_Calc$NB_92, na.rm = TRUE) / sum(Nro_AfMaior15, na.rm = TRUE)) > 0) {PInvalidez = sum(DB_Calc$NB_92, na.rm = TRUE) / sum(Nro_AfMaior15, na.rm = TRUE)} else {PInvalidez = rep(0, 10)}
if((sum(DB_Calc$NB_91, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE))>0) {FatorB91 = sum(DB_Calc$NB_91, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB91 = rep(0, 10)}
if((sum(DB_Calc$NB_92, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE))>0) {FatorB92 = sum(DB_Calc$NB_92, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB92 = rep(0, 10)}
if((sum(DB_Calc$NB_93, na.rm = TRUE) / sum(DB_Calc$Nev_Obito_Tipico, na.rm = TRUE))>0) {FatorB93 = sum(DB_Calc$NB_93, na.rm = TRUE) / sum(DB_Calc$Nev_Obito_Tipico, na.rm = TRUE)} else {FatorB93 = rep(1, 10)}
if((sum(DB_Calc$NB_94, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE))>0) {FatorB94 = sum(DB_Calc$NB_94, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB94 = rep(0, 10)}
...
if(regressao_PercentilcustoFAP$coefficients[1] > -1000){Beta0ICustoFAP = regressao_PercentilcustoFAP$coefficients[1]} else {Beta0ICustoFAP = rep(-99.99, 10)}
if(regressao_PercentilcustoFAP$coefficients[2] > -1000){Beta1ICustoFAP = regressao_PercentilcustoFAP$coefficients[2]} else {Beta1ICustoFAP = rep(-99.99, 10)}

# Regressao Percentilfrequencia FAP
regressao_PercentilfrequenciaFAP = lm(Percentilfrequencia ~ Indicefrequencia, DB_Calc)
if(regressao_PercentilfrequenciaFAP$coefficients[1] > -1000){Beta0IFrequenciaFAP = regressao_PercentilfrequenciaFAP$coefficients[1]} else {Beta0IFrequenciaFAP = rep(-99.99, 10)}
if(regressao_PercentilfrequenciaFAP$coefficients[2] > -1000){Beta1IFrequenciaFAP = regressao_PercentilfrequenciaFAP$coefficients[2]} else {Beta1IFrequenciaFAP = rep(-99.99, 10)}

# Regressao Percentilgravidade FAP
regressao_PercentilgravidadeFAP = lm(Percentilgravidade ~ Indicegravidade, DB_Calc)
if(regressao_PercentilgravidadeFAP$coefficients[1] > -1000) {Beta0IGravidadeFAP = regressao_PercentilgravidadeFAP$coefficients[1]} else {Beta0IGravidadeFAP = rep(-99.99, 10)}
if(regressao_PercentilgravidadeFAP$coefficients[2] > -1000) {Beta1IGravidadeFAP = regressao_PercentilgravidadeFAP$coefficients[2]} else {Beta1IGravidadeFAP = rep(-99.99, 10)}

# Regressao ReajustePlanoP
regressao_ReajustePlano = lm(ReajustePlanoEstimado ~ TaxaGravidade, DB_Calc)
if(regressao_ReajustePlano$coefficients[1] > -1000) {Beta0ReajustePlano = regressao_ReajustePlano$coefficients[1]} else {Beta0ReajustePlano = rep(-99.99, 10)}
BetaFreqReajustePlano = rep(0, 10)
if(regressao_ReajustePlano$coefficients[2] > -1000) {BetaGravReajustePlano = regressao_ReajustePlano$coefficients[2]} else {BetaGravReajustePlano = rep(-99.99, 10)}
...
#DB_ASIS_Completo_Arbitrado_prov_t2 = data.frame(t(DB_ASIS_Completo_Arbitrado_prov_t))
...
### ------------------------------------------------------
dataset_INIC_AnosAvaliacao = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", 
...
dataset_INIC_Selecao = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", 
...
### ------------------------------------------------------
dataset_INIC_Projetado = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", 
...
### ------------------------------------------------------
dataset_INIC_BASELINE = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", 
...
for(v in 1:17){
  # Seleciona o número de eventos média ou último ano.
  if(dataset_INIC_BASELINE[v, ] == "Média") {dataset_INIC_BASELINE_prob[v, 1] = eventos_pdf[v, 7] / Funcionarios_media
  }                                    else {dataset_INIC_BASELINE_prob[v, 1] = eventos_pdf[v, 6] / Funcionarios_ultimoano} 
...
if(dataset_INIC_Selecao[1, 3] == TRUE){
  dataset_Inic1_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 1!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){
  dataset_Inic2_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 2!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){
  dataset_Inic3_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 3!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){
  dataset_Inic4_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 4!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){
  dataset_Inic5_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 5!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){
  dataset_Inic6_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 6!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){
  dataset_Inic7_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 7!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){
  dataset_Inic8_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 8!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){
  dataset_Inic9_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 9!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){
  dataset_Inic10_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 10!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[1, 3] == TRUE){
  dataset_Inic1_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 1!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){
  dataset_Inic2_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 2!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){
  dataset_Inic3_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 3!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){
  dataset_Inic4_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 4!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){
  dataset_Inic5_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 5!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){
  dataset_Inic6_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 6!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){
  dataset_Inic7_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 7!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){
  dataset_Inic8_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 8!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){
  dataset_Inic9_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 9!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){
  dataset_Inic10_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 10!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[1, 3] == TRUE){dataset_Inic1_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 1!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){dataset_Inic2_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 2!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){dataset_Inic3_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 3!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){dataset_Inic4_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 4!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){dataset_Inic5_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 5!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){dataset_Inic6_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 6!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){dataset_Inic7_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 7!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){dataset_Inic8_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 8!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){dataset_Inic9_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 9!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){dataset_Inic10_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx", range = "Iniciativa 10!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[1, 3] == TRUE){dataset_Inic1_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 1!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){dataset_Inic2_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 2!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){dataset_Inic3_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 3!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){dataset_Inic4_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 4!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){dataset_Inic5_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 5!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){dataset_Inic6_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 6!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){dataset_Inic7_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 7!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){dataset_Inic8_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 8!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){dataset_Inic9_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 9!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){dataset_Inic10_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 10!I41:I46",col_names = FALSE))
...
### Outros Ganhos
if(dataset_INIC_Selecao[1, 3] == TRUE){dataset_Inic1_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 1!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){dataset_Inic2_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 2!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){dataset_Inic3_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 3!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){dataset_Inic4_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 4!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){dataset_Inic5_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 5!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){dataset_Inic6_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 6!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){dataset_Inic7_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 7!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){dataset_Inic8_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 8!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){dataset_Inic9_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 9!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){dataset_Inic10_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.2.xlsx",range = "Iniciativa 10!I52:K58", col_names = FALSE))
...
# ## Calculo das Pev a partir dados arbitrados para as iniciativas
# Pev_Afmenor15_Tipico = dataset_Inic1_PrEventos_Arb[-11,] / Funcionarios_ultimoano

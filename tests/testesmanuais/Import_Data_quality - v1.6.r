...
if(sum(DB_Calc$Aux_DespesaTotalB93, na.rm = TRUE) > 0){CustoMedio_NB_93 = (DB_Calc$Aux_DespesaTotalB93 / DB_Calc$NB_93)} else {CustoMedio_NB_93 = rep(0, 10)}
...
if(sum(DB_Calc$NB_92 / sum(Nro_AfMaior15), na.rm = TRUE)>0) {PInvalidez = sum(DB_Calc$NB_92, na.rm = TRUE) / sum(Nro_AfMaior15, na.rm = TRUE)} else {PInvalidez = rep(1, 10)}
if(sum(DB_Calc$NB_91 / sum(Nro_AfMaior15_Doenca_Acidente), na.rm = TRUE)>0) {FatorB91 = sum(DB_Calc$NB_91, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB91 = rep(1, 10)}
if(sum(DB_Calc$NB_92 / sum(Nro_AfMaior15_Doenca_Acidente), na.rm = TRUE)>0) {FatorB92 = sum(DB_Calc$NB_92, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB92 = rep(1, 10)}
if(sum(DB_Calc$NB_93 / sum(DB_Calc$Nev_Obito_Tipico), na.rm = TRUE)>0) {FatorB93 = sum(DB_Calc$NB_93, na.rm = TRUE) / sum(DB_Calc$Nev_Obito_Tipico, na.rm = TRUE)} else {FatorB93 = rep(1, 10)}
if(sum(DB_Calc$NB_94 / sum(Nro_AfMaior15_Doenca_Acidente), na.rm = TRUE)>0) {FatorB94 = sum(DB_Calc$NB_94, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB94 = rep(1, 10)}
...
### ------------------------------------------------------
dataset_INIC_AnosAvaliacao = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", 
...
dataset_INIC_Selecao = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", 
...
### ------------------------------------------------------
dataset_INIC_Projetado = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", 
...
### ------------------------------------------------------
dataset_INIC_BASELINE = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", 
...
dataset_INIC_BASELINE_prob = data.frame(dataset_INIC_BASELINE / Funcionarios_media)
...
dataset_INIC_BASELINE = rbind(dataset_INIC_BASELINE, dataset_INIC_BASELINE_prob)
...
if(dataset_INIC_Selecao[1, 3] == TRUE){
  dataset_Inic1_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 1!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){
  dataset_Inic2_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 2!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){
  dataset_Inic3_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 3!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){
  dataset_Inic4_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 4!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){
  dataset_Inic5_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 5!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){
  dataset_Inic6_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 6!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){
  dataset_Inic7_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 7!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){
  dataset_Inic8_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 8!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){
  dataset_Inic9_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 9!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){
  dataset_Inic10_Custos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 10!D8:M10", col_names = TRUE))
...
if(dataset_INIC_Selecao[1, 3] == TRUE){
  dataset_Inic1_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 1!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){
  dataset_Inic2_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 2!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){
  dataset_Inic3_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 3!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){
  dataset_Inic4_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 4!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){
  dataset_Inic5_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 5!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){
  dataset_Inic6_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 6!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){
  dataset_Inic7_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 7!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){
  dataset_Inic8_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 8!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){
  dataset_Inic9_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 9!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){
  dataset_Inic10_PrEventos_Obs = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 10!K18:k34", col_names = FALSE))
...
if(dataset_INIC_Selecao[1, 3] == TRUE){dataset_Inic1_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 1!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){dataset_Inic2_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 2!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){dataset_Inic3_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 3!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){dataset_Inic4_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 4!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){dataset_Inic5_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 5!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){dataset_Inic6_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 6!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){dataset_Inic7_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 7!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){dataset_Inic8_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 8!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){dataset_Inic9_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 9!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){dataset_Inic10_PrEventos_Arb = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx", range = "Iniciativa 10!O18:Q34",col_names = FALSE))
...
if(dataset_INIC_Selecao[1, 3] == TRUE){dataset_Inic1_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 1!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){dataset_Inic2_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 2!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){dataset_Inic3_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 3!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){dataset_Inic4_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 4!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){dataset_Inic5_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 5!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){dataset_Inic6_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 6!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){dataset_Inic7_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 7!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){dataset_Inic8_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 8!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){dataset_Inic9_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 9!I41:I46",col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){dataset_Inic10_PrEventosRaros = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 10!I41:I46",col_names = FALSE))
...
### Outros Ganhos
if(dataset_INIC_Selecao[1, 3] == TRUE){dataset_Inic1_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 1!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[2, 3] == TRUE){dataset_Inic2_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 2!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[3, 3] == TRUE){dataset_Inic3_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 3!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[4, 3] == TRUE){dataset_Inic4_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 4!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[5, 3] == TRUE){dataset_Inic5_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 5!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[6, 3] == TRUE){dataset_Inic6_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 6!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[7, 3] == TRUE){dataset_Inic7_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 7!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[8, 3] == TRUE){dataset_Inic8_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 8!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[9, 3] == TRUE){dataset_Inic9_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 9!I52:K58", col_names = FALSE))
...
if(dataset_INIC_Selecao[10, 3] == TRUE){dataset_Inic10_Ganhos = data.frame(read_excel(path = "CBA_SESI_Planilha_Dados_Entrada_Iniciativas - v1.0.xlsx",range = "Iniciativa 10!I52:K58", col_names = FALSE))

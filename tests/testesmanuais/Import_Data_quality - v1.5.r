...
#### Folders & Files
PATH_DATAFILES = "C:/Users/LFC/Desktop/SESI/Modelagem dados entrada/Aplicacao1"
...
# eventos_pdf
# eventos_pdf_arb
rmarkdown::render("C:/Users/LFC/Desktop/SESI/Modelagem dados entrada/_R/report.Rmd", encoding = getOption("encoding"))
...
if(sum(DB_Calc$NB_91 / Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)>0) {FatorB91 = sum(DB_Calc$NB_91, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB91 = rep(1, 10)}
if(sum(DB_Calc$NB_92 / Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)>0) {FatorB92 = sum(DB_Calc$NB_92, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB92 = rep(1, 10)}
if(sum(DB_Calc$NB_93 / DB_Calc$Nev_Obito_Tipico, na.rm = TRUE)>0) {FatorB93 = sum(DB_Calc$NB_93, na.rm = TRUE) / sum(DB_Calc$Nev_Obito_Tipico, na.rm = TRUE)} else {FatorB93 = rep(1, 10)}
if(sum(DB_Calc$NB_94 / Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)>0) {FatorB94 = sum(DB_Calc$NB_94, na.rm = TRUE) / sum(Nro_AfMaior15_Doenca_Acidente, na.rm = TRUE)} else {FatorB94 = rep(1, 10)}

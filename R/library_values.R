...
oshcba_options = list(
  ...
  variaveis_a_descontar = c("CustoTotal", "DespesaTurnover", "DespesaAbsenteismo", "DespesaMultas"),
  ...
  v_funcoes = c("calcular_absenteismo", "calcular_eventos", "calcular_faltas", "calcular_turnover", "calcular_multas"),

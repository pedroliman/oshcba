...
| Símbolo | Definição |
|-------|-------------------------------------------------------------------------------------------------|
| $\alpha$ | Razão Benefício-Custo. Para 1 Real investido na iniciativa indicada, retornam $\alpha$ reais.|
...
$$N_{b31} = Nev_{NRelacionadoAoTrabalho, af>15} * P_{Invalidez}$$
...
$$I_c = \frac{\sum_{i=91}^{94} n_{i}*cmed_{i}}{folhamédio}/ * 1000$$

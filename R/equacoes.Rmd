...
Considerando a necessidade de estimar o percentil a partir dos eventos, será utilizada uma regressão linear relacionando o percentil ao número de eventos observados na empresa.
$$p_t = \beta_{0,percent} +\beta_{1,percent} * \sum_{k=1}^{K} {\sum_{c=1}^{C} {n_{acidentes \ k,c, t \in{(-1,-2)}}$$

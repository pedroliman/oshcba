...
| $Nev_{c,k}$ | Número de Eventos do tipo $k$ com a consequência $c$|
| $k$ | Índice que indexa os tipos de eventos, $k \in K = \{Típico, Trajeto, Doença Não Ocupacional, Não RelacionadoAoTrabalho\}$ |
| $c$ | Índice que indexa as consequências dos eventos, $c \in C = \{Afastamento<15, Afastamento>15, Óbito, Sem Afastamento\}$ |
| $Pev_{k}$ | Percentual de Funcionários que irá sofrer o evento $k$ em um período. |
| $Pev_c$ | 
...
Ajuste 1:
$$FAP = 0,5 + 0,5 * IC \ if \ (IC < 1, turnover < 0,75) $$

Ajuste 2:

$$FAP = 1 \ if \ IC < 1, (turnover > 0,75)$$

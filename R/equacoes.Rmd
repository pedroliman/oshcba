...
##### Despesas com Reclamatórias Trabalhistas (OK)
...
###### Número de Reclamatórias Trabalhistas (OK)
...
##### Acidente / Doença Ocupacional - Invalidez ](OK)

Esta subcategoria compreende as despesas evitadas com incapacitação parcial ou total provocada por acidente típico, doença ocupacional ou acidente de trajeto após a implementação integral da iniciativa. Todos os custos incorridos nesta rúbrica entram no cálculo de outras categorias e não deveriam ser contados em duplicidade.

##### Ações Regressivas INSS (OK)
...
##### Interdições Por Fiscalização (OK)
...
##### MP, Insumos, Equipamentos Operação (OK)

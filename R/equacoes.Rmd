...
### Calculo dos Eventos
Em todos os casos, o número de eventos será calculado a partir da multiplicação do número de funcionários da empresa $f$, a probabilidade do evento $c$ ocorrer $Pev_c$, e a probabilidade do tipo de acidente $k$ ocorrer $Pev_{k}$. Os eventos $c$ pertece ao conjunto $C =\{afastamento<15, afastamento>15, óbito, sem afastamento\}$ e os tipos de acidente $k$ pertencem ao conjunto $K= \{típico, trajeto, doença não ocupacional\}$. 
...
***Dúvida: Este número será correspondente ao número de funcionários que recebeu benefício. Sendo assim, não pode ser usado como um índice de gravidade, e sim de frequência. Esta dúvida se aplica a todos Nb**
...
* Exceto para Tipos de Acidentes não relacionados ao trabalhos.
...
### Calculo dos Benefícios da Iniciativa
...
#### Intangível
Categorias a Modelar: Imagem da Empresa, Engajamento e Clima organizacional.
...
##### Categorias a Modelar (Melhor Uso dos Recursos):
Presenteísmo, Produtividade, Qualidade, Refugo e Retrabalho, MP Insumos e Equipamentos.

...
#### Turnover Geral
$$Turn_geral = \frac{Nev_{af_{>15},k} + Nev_{obito,k} + Deslig_{voluntarios} + Turn_{informado}}{f}$$
...
Turnover Voluntário + Turnover "Normal"
...
$$t_{contrat} = \beta_{0,tcontrat} + \beta_{f,tcontrat} * I_{fa} + \beta_{g,tcontrat} * I_{ga}$$
...
$$Perc_{desligvoluntarios} = \beta_{0,desvolunt} +\beta_{f,desvolunt} * I_{fa} + \beta_{g,desvolunt} * I_{ga} $$
